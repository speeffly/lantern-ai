...
export default function CounselorAnalyticsPage() {
  ...
  const checkAuth = async () => {
    ...
    console.log('🔍 Counselor Analytics - Checking authentication...');
    ...
    try {
      ...
      console.log('🔍 Counselor Analytics - Profile response:', data);
      ...
      console.log('✅ Counselor authentication successful for analytics page');
    } catch (error) {
