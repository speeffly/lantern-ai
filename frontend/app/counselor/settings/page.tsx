...
export default function CounselorSettingsPage() {
  ...
  const checkAuth = async () => {
    ...
    console.log('🔍 Counselor Settings - Checking authentication...');
    ...
    try {
      ...
      console.log('🔍 Counselor Settings - Profile response:', data);
      
      if (data.success && data.data.role === 'counselor') {
        console.log('✅ Counselor authentication successful for settings page');
        setUser(data.data);
      } else {
