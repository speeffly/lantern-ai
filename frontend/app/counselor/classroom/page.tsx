...
export default function CounselorClassroomPage() {
  ...
  const checkAuth = async () => {
    ...
    console.log('🔍 Counselor Classroom - Checking authentication...');
    ...
    try {
      ...
      console.log('🔍 Counselor Classroom - Profile response:', data);
      ...
      console.log('✅ Counselor authentication successful for classroom page');
    } catch (error) {
