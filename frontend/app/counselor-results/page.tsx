        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="text-center mb-6">
              ...
              {(recommendations.aiRecommendations as any) && !(recommendations.aiRecommendations as any)?.academicPlan?.error ? (
              ...
              ) : recommendations.aiRecommendations && recommendations.aiRecommendations.academicPlan && (recommendations.aiRecommendations.academicPlan as any)?.error ? (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {recommendations.aiRecommendations.localJobs.slice(0, 6).map((job: any, index: number) => (
                              <div key={index} className="border border-gray-100 rounded-lg p-4 bg-gray-50">
                                ...
                                {job.distance && (
                                  <p className="text-xs text-gray-500 mt-1">📍 {job.distance} miles away</p>
                                )}
                              </div>
                            ))}
                          </div>
