...
Generated by Lantern AI Career Guidance Platform
  ...
  const handleCareerSelect = (careerId: string) => {
    ...
    // You could also navigate to a more detailed view or update the UI
    // For now, we'll just log it and let the component handle the visual feedback
  };
                    ...
                    <div className="space-y-8">
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                        ...
                        <p className="text-blue-800">
                          Since you're exploring different career options, your 4-year plan will be customized once you select a specific career path from the Career Options tab. 
